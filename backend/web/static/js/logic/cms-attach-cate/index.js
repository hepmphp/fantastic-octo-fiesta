...
var urls = {
    create_url:'?r=cms-attach-cate/create',
    update_url:'?r=cms-attach-cate/update',
    delete_url:'?r=cms-attach-cate/delete'
};
...
function layer_form(url,action){
    ...
    layer.open({
        ...
        yes: function(index, layero){
            ...
            //todo生成js验证
            if(param.CmsAttachCate.id){
                var url = urls.update_url+'&id='+param.CmsAttachCate.id;
            }else{
                var url = urls.create_url
            }
            ajax_post(url,param);
