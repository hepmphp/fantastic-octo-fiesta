...
$('#btn_list').click(function(){
    ...
    layer.open({
        ...
        btn: [],
        shade: 0.3, //遮罩透明度
        content:"?r=developer/create-list&fields="+fields+"&form_builder_types="+form_builder_types+"&table="+table
    });
});
...
$('#btn_controller').click(function(){
    ...
    layer.open({
        ...
        btn: [],
        shade: 0.3, //遮罩透明度
        content:"?r=developer/create-controller&fields="+fields+"&form_builder_types="+form_builder_types+"&table="+table
    });
});
