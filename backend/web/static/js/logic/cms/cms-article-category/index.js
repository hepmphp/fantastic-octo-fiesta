...
var urls = {
    create_url:'?r=cms/cms-article-category/create',
    update_url:'?r=cms/cms-article-category/update',
    delete_url:'?r=cms/cms-article-category/delete'
};
        ...
        yes: function(index, layero){
            ...
            var param ={
                ...
                CmsArticleCategory:{
					...
					parent_id:body.find('#parent_id').val(),
